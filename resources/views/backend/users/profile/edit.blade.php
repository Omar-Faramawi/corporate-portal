...
<section class="content-header">
    <h1><i class="livicon" data-name="user" data-size="25" data-c="#418BCA" data-hc="#01BC8C" data-loop="true"></i>{{ trans('backend.edit') }} {{ trans('backend.my_profile') }}</h1>
    <ol class="breadcrumb">
      <li><a href="/{{ Lang::getlocale() }}/admin"> {{ trans('backend.dashboard') }}</a></li>
      <li class="active"> {{ trans('backend.edit') }} {{ trans('backend.my_profile') }}</li>
    </ol>   
</section>
@endsection
     ...
     <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="livicon" data-name="user" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i>{{ trans('backend.edit') }} {{ trans('backend.my_profile') }}</h3>
            </div>
            <div class="panel-body">
                <form action="{{ action('UsersController@update_profile', $user->id) }}" method="POST" role="form">
