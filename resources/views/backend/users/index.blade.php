...
<section class="content-header">
    <h1><i class="livicon" data-name="list" data-size="25" data-c="#418BCA" data-hc="#01BC8C" data-loop="true"></i>{{ trans('backend.list_users') }}</h1>
    <ol class="breadcrumb">
      <li><a href="/admin"><i class="fa fa-tachometer"></i> {{ trans('backend.dashboard') }}</a></li>
      <li class="active"> {{ trans('backend.list_users') }}</li>
    </ol>   
</section>
@endsection
        ...
        <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="table-responsive">
                     ...
                     <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <span class="pull-right sort">
                                        @if(isset($_GET['name']))
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Asc' && isset($_GET['orderby']) && $_GET['orderby'] == 'name') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=name&sort=Asc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-asc"></i></a>
                                ...
                                <th>
                                    ...
                                    <span class="pull-right sort">
                                        ...
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Asc' && isset($_GET['orderby']) && $_GET['orderby'] == 'created_by') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=created_by&sort=Asc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-asc"></i></a>
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Desc' && isset($_GET['orderby']) && $_GET['orderby'] == 'created_by') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=created_by&sort=Desc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-desc"></i></a>
                                        @else
                                ...
                                <th>
                                    ...
                                    <span class="pull-right sort">
                                        ...
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Asc' && isset($_GET['orderby']) && $_GET['orderby'] == 'updated_by') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=updated_by&sort=Asc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-asc"></i></a>
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Desc' && isset($_GET['orderby']) && $_GET['orderby'] == 'updated_by') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=updated_by&sort=Desc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-desc"></i></a>
                                        @else
                                ...
                                <th>
                                    ...
                                    <span class="pull-right sort">
                                        ...
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Asc' && isset($_GET['orderby']) && $_GET['orderby'] == 'created_at') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=created_at&sort=Asc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-asc"></i></a>
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Desc' && isset($_GET['orderby']) && $_GET['orderby'] == 'created_at') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=created_at&sort=Desc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-desc"></i></a>
                                        @else
                                ...
                                <th>
                                    ...
                                    <span class="pull-right sort">
                                        ...
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Asc' && isset($_GET['orderby']) && $_GET['orderby'] == 'updated_at') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=updated_at&sort=Asc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-asc"></i></a>
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Desc' && isset($_GET['orderby']) && $_GET['orderby'] == 'updated_at') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=updated_at&sort=Desc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-desc"></i></a>
                                        @else
                                ...
                                <th>
                                    ...
                                    <span class="pull-right sort">
                                        ...
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Asc' && isset($_GET['orderby']) && $_GET['orderby'] == 'active') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=active&sort=Asc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-asc"></i></a>
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Desc' && isset($_GET['orderby']) && $_GET['orderby'] == 'active') class="active" @endif href="{{url(''.Lang::getlocale().'/admin/users/?name='.$_GET['name'].'&created_by='.$_GET['created_by'].'&updated_by='.$_GET['updated_by'].'&created_at='.$_GET['created_at'].'&last_update='.$_GET['last_update'].'&active='.$_GET['active'].'&orderby=active&sort=Desc&page='.isset($_GET['page']).'')}}"><i class="fa fa-sort-desc"></i></a>
                                        @else
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Asc' && isset($_GET['orderby']) && $_GET['orderby'] == 'active') class="active" @endif href="?orderby=active&sort=Asc"><i class="fa fa-sort-asc"></i></a>
                                        <a @if(isset($_GET['sort']) && $_GET['sort'] == 'Desc' && isset($_GET['orderby']) && $_GET['orderby'] == 'active') class="active" @endif href="?orderby=active&sort=Desc"><i class="fa fa-sort-desc"></i></a>
                                        @endif
                                    </span>
                                </th>
                        ...
                        @if($user->id != '1')
                            <tr>
                                <td>
                                    <input type="checkbox" name="ids[]" class="check_list" value="{{$user->id}}">
                                </td>
                                <td>
                                    @if($user->image)
                                    <img src="/{{ $user->image->thumbnail }}" width="70">
                                    @else
                                    <img src="{{ asset('assets/img/user.png') }}" width="70">
                                    @endif
                                </td>
                                <td>
                                 {{ $user->name }}
                                ...
                                @if($user->user_role)
                                    ...
                                    @if($user->user_role->role->trans)
                                    {{ $user->user_role->role->trans->title }}
                                    @endif
                                    @endif
                                @endif
                                </td>
                                ...
                                <td>
                                    @if($user->active == '1')
                                       <a href="{{action('UsersController@single_status', ['2',$user->id])}}" class="label label-sm label-success"><span class="glyphicon glyphicon-ok"></span> {{ trans('backend.active') }}</a>
                                    @elseif($user->active == '2')
                                        <a href="{{action('UsersController@single_status', ['1',$user->id])}}" class="label label-sm label-warning"><span class="glyphicon glyphicon-ban-circle"></span> {{ trans('backend.not_active') }}</a>
                                    @elseif($user->active == '3')
                                        <a href="{{action('UsersController@single_status', ['1',$user->id])}}" class="label label-sm label-danger"><span class="glyphicon glyphicon-ban-circle"></span> {{ trans('backend.blocked') }}</a>
                                    @endif
                                </td>
                                <td class="">
                                <a href="{{action('UsersController@edit', $user->id)}}"><i class="fa  fa-edit"></i> {{ trans('backend.edit') }}</a>
                                <a onclick="confirmDelete(this)" data-toggle="modal" data-href="#full-width" data-id="{{ $user->id }}" data-title="{{ $user->name }}" href="#full-width"><i class="fa fa-trash-o"></i> {{ trans('backend.delete') }}</a>
                               </td>
                            </tr>
                        @endif
                        @endforeach
                        ...
                        <div class="text-center">
                            ...
                            <h1>{{ trans('backend.no_results_found') }}
                             <a href="/{{Lang::getlocale()}}/admin/users">{{ trans('backend.back') }}</a></h1>
                            @elseif(Request::is(''.Lang::getlocale().'/admin/users/'))
                            <h1>{{ trans('backend.no_data_added_before') }}
                             <a href="/{{Lang::getlocale()}}/admin/users/create">{{ trans('backend.create_content') }}</a></h1>
                            @endif
                         </div>
                        @endif
                    @if($users->count())
                    ...
                    <div class="form-group bulk">
                        ...
                        <a class="btn btn-success btn-large" onclick="submitForm('{{action('UsersController@bulk_status', '1')}}')"><span class="glyphicon glyphicon-ok"></span> {{ trans('backend.bulk_active') }}</a>

                        <a class="btn btn-warning btn-large" onclick="submitForm('{{action('UsersController@bulk_status', '2')}}')"><span class="glyphicon glyphicon-ban-circle"></span> {{ trans('backend.bulk_deactivate') }}</a>

                        <a class="btn btn-danger btn-large" onclick="submitForm('{{action('UsersController@bulk_status', '3')}}')"><span class="glyphicon glyphicon-ban-circle"></span> {{ trans('backend.bulk_block') }}</a>
                    </div>
                   </form>
                   <div class="table-footer">
                         <div class="count"> <i class="fa fa-folder-o"></i> {{ trans('backend.total') }} : {{ $users->total() }} {{ trans('backend.user') }} </div>
                        <div class="pagination-area"> {!! $users->render() !!} </div>
                    </div>
                @endif
                </div>
            </div>
...
<script type="text/javascript">
    function bulkconfirmDelete() {
        ...
        http.open("POST", "{{action('UsersController@bulk_destroy_confirm')}}", true);
