...
<section class="content-header">
    <h1><i class="livicon" data-name="list" data-size="25" data-c="#418BCA" data-hc="#01BC8C" data-loop="true"></i>{{ trans('backend.edit') }} {{ trans('backend.implinks') }}</h1>
    <ol class="breadcrumb">
      ...
      <li class="active"> {{ trans('backend.edit') }} {{ trans('backend.implinks') }}</li>
    </ol>   
</section>
@endsection
     ...
     <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                        <h3 class="panel-title"><i class="livicon" data-name="list" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i>{{ trans('backend.edit') }} {{ trans('backend.implinks') }}</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ action('ImpLinksController@update', [$items->id]) }}" method="POST" role="form">
