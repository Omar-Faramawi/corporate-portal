...
<ol class="breadcrumb">
    ...
    <li class="active">عرض قائمة الالبومات</li>
</ol>
@endsection
                @section('content')
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach($images as $image)
                                                        @if ($view->id == $image->pgallery_id)
                                                            <img src="/img/uploaded/pgallery/{{ $image->images }}" style="width:70px; height:50px; ">
                                                            <?php
                                                                break;
                                                            ?>
                                                        @endif
                                                ...
                                                <td>{{ $view->name }}</td>
                                                <td>
                                                    <a href="/admin/pgallery/{{$view->id}}/edit">تعديل</a> - 
                                                    <a href="/admin/pgallery/{{$view->id}}/delete">حذف</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
