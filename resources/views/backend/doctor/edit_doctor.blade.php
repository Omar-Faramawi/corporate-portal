...
<ol class="breadcrumb">
    ...
    <li class="active">تعديل بطاقات الاعضاء</li>
</ol>
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
         <div class="panel panel-primary" id="hidepanel1">
                ...
                <div class="panel-body">
                    {!! Form::model($doctor, [$doctor->id, 'files' => true, 'method' => 'POST']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    <img src="/img/uploaded/doctor/{{ $doctor->basic_photo }}" alt="..."></div>
                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"></div>
                                <div>
                                    <span class="btn btn-default btn-file">
                                        <span class="fileinput-new">اختر صورة</span>
                                        <span class="fileinput-exists">تغيير</span>
                                        <input type="file" id="basic_photo" name="basic_photo"  class="upload_photos" value="C:\wamp\www\laravel\wedding\public\img\uploaded\doctor/Desert.jpg"></span>
                        ...
                        <div class="form-group">
                          <label for="الاسم" style="">التخصص</label><br>
