				                ...
				                <div class="panel-body">
				                    <form action="{{ action('ContactsController@update', $gmap->id) }}" method="POST" role="form">
										...
										<div class="form-group">
											{{ trans('backend.Address In Arabic') }}: <input  style="width:80%;" type="text" id="address_ar" name="address_ar" value="{{$gmap->address_ar}}"/>
										</div>
					                    ...
					                    <div  class="transfer">
						                    <div class="form-inline">
						                    	<div class="form-group">
													العنوان: <input type="text" id="address" value="{{$gmap->address}}" />
												</div>
												<div class="form-group">
													خط العرض: <input type="text" id="latitude" value="{{$gmap->latitude}}" />
												</div>
												<div class="form-group">
													خط الطول: <input type="text" id="longitude" value="{{$gmap->longitude}}" />
												</div>
											</div>
										</div>
				                        <div class="form-group">
