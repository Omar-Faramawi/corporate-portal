...
<section class="content-header">
    ...
    <ol class="breadcrumb">
          ...
          <li class="active"><i class="fa fa-flag-o"></i> {{ trans('backend.list_messages')}}</li>
    </ol>   
</section>
@endsection
...
@section('content')
<!-- Include filter -->
@include('backend.contacts.filter')
<!-- end include filter -->  
...
@include('backend.contacts.bulk-confirm-delete')
                  ...
                  <div class="portlet-title">
                   ...
                   <div class="portlet-body">
                          <div class="table-responsive">
                                ...
                                @endif
                                 <div class="count"> <i class="fa fa-folder-o"></i> {{ trans('backend.total')}} : {{ $contacts->total() }} {{ trans('backend.message')}} </div>
                                 <div class="pagination-area"> {!! $contacts->render() !!} </div>
                        </div>         
                  </div>
      </div>
...
<script type="text/javascript">
    function bulkconfirmDelete() {
        ...
        http.open("POST", "{{action('ContactsController@bulk_destroy_confirm')}}", true);
