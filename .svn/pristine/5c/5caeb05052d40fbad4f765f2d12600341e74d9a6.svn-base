...
<section class="content-header">
    <h1><i class="livicon" data-name="list" data-size="25" data-c="#418BCA" data-hc="#01BC8C" data-loop="true"></i>{{ trans('backend.create') }} {{ trans('backend.banners') }}</h1>
    <ol class="breadcrumb">
      ...
      <li class="active"> {{ trans('backend.create') }} {{ trans('backend.banners') }}</li>
    </ol>   
</section>
@endsection
     ...
     <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="{{ action('BannersController@store') }}" method="POST" role="form">
