...
<ol class="breadcrumb">
    ...
    <li>
        <a href="/admin/banners/list">قائمة البنرات</a>
    </li>
    <li class="active">تعديل بيانات البنر</li>
</ol>
@endsection
@section('content')
<div class="row">
         ...
         <div class="panel panel-primary" id="hidepanel1">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    ...
                                    تعديل بيانات البنر  {{$banner->title}}
                                </h3>
                            </div>
                <div class="panel-body">
                    {!! Form::model($banner, [$banner->id, 'files' => true, 'method' => 'POST']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    <img src="/img/uploaded/banner/{{ $banner->basic_photo }}" alt="..."></div>
