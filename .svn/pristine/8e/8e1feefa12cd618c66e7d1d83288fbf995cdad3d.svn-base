			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align:center;"> <!-- section title -->
						<h2>{{trans('backend.Log In')}}</h2>
					</div> <!-- End section title -->
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form_holder"> <!-- form holder -->
						<form action="{{ action('LoginController@postLoginGuest') }}" class="contact-form" method="POST" role="form">
						    ...
						    <button type="submit" class="submit">{{trans('backend.Log In') }} <i class="fa fa-arrow-circle-right"></i></button>
