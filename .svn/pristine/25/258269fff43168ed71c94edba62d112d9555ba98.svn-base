...
<ol class="breadcrumb">
    ...
    <li class="active">تعديل الخبر</li>
</ol>
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
         <div class="panel panel-primary" id="hidepanel1">
                ...
                <div class="panel-body">
                    {!! Form::model($news, [$news->id, 'files' => true, 'method' => 'POST']) !!}
                        ...
                        <div class="form-group">
                          <label for="الاسم" style="">ملخص الخبر</label><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    <img src="/img/uploaded/{{ $news->basic_photo }}" alt="..."></div>
                        ...
                        <div class="form-group">
                            @if ($news->importance == 1)
                                <input type="checkbox" name="importance" value="checked" checked> <b>وضع الخبر ضمن الأخبار المهمة</b>
                            @else
                                <input type="checkbox" name="importance" value="checked"> <b>وضع الخبر ضمن الأخبار المهمة</b>
                            @endif
                        </div>
                        <div class="form-group">
                            {!! Form::submit('تعديل', 
    ...
    <div class="col-md-12">
         <div class="panel panel-primary" id="hidepanel1">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="livicon" data-name="clock" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                                    تعديل الصور الخاصة بالخبر {{$news->title}}
                                </h3>
                                <span class="pull-right">
                                    <i class="glyphicon glyphicon-chevron-up clickable"></i>
                                    <i class="glyphicon glyphicon-remove removepanel clickable"></i>
                ...
                <div class="panel-body">
                        {!! Form::model($news, [$news->id, 'files' => true, 'method' => 'PATCH']) !!}
                        <div class="form-group">
                            {!! Form::label('الصور') !!}<br>
                            @if ($images->count())
...
<script type="text/javascript">
  $(document).ready(function($){
        $('button.btn.btn-primary.delete_photo_ajax').click(function(){
            var id = $(this).val();
            $.post("/admin/delete/news/{{$news->id}}/photos/"+ id,
            function(data) {
