...
<section class="content-header">
    <h1><i class="livicon" data-name="list" data-size="25" data-c="#418BCA" data-hc="#01BC8C" data-loop="true"></i>{{ trans('backend.edit') }} {{ trans('backend.pages') }}</h1>
    <ol class="breadcrumb">
      ...
      <li class="active"> {{ trans('backend.edit') }} {{ trans('backend.pages') }}</li>
    </ol>   
</section>
@endsection
     ...
     <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ action('PagesController@update', [$pages->id]) }}" method="POST" role="form">
                            ...
                            <div class="col-md-3 sidbare">
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label><input name="published" type="checkbox" value="1" class="minimal-blue" @if($pages->published == '1' || old('back') == 1) checked @endif> {{ trans('backend.published') }}</label>
                                    </div>
                                    <div class="checkbox">
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input name="menu_active" id="menu-active" type="checkbox" value="1" @if(old('menu-active') == '1') checked @elseif($pages->menu_active == '1') checked @endif>
                                ...
                                <div class="form-group" id="menu-group">
                                    ...
                                    <select name="menu" class="form-control">
                                        ...
                                        <option value="{{ $menu->id }}"@if( old('menu') == $menu->id) @elseif(isset($pages->menu_id) && $menu->id == $pages->menu_id) selected @endif>{{ $menu->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @endif
