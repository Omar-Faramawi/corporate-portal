				...
				<div class="container">
					...
					<div class="row brand_name"> <!-- For brand title and logo -->
						<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
							<a href="/{{Lang::getLocale()}}/services/{{$service->id}}"><img class="img-responsive" src="/{{$service->image->thumbnail}}" alt="{{$service->title}}"></a> <!-- Logo -->
						</div>
						<div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
							<h3><a href="/{{Lang::getLocale()}}/services/{{$service->id}}">{{$service->title}}</a></h3>
							<?php
			                    $limit = 190;
						...
						<div class="col-lg-2 col-md-2 col-sm-1 col-xs-12">
							<div style="margin-top: 150px;">
                                <a href="/{{Lang::getLocale()}}/services/{{$service->id}}" style="border-radius:50%;padding:10px;background-color:#053A6E;color:#eee;">{{trans('backend.Details')}}</a>
                            </div>
						</div>
					</div>
					@endforeach
